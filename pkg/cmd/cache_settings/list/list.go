...
func NewCmd(f *cmdutil.Factory) *cobra.Command {
    ...
    cmd := &cobra.Command{
        ...
        SilenceErrors: true, 
        Example: heredoc.Doc(`
        $ azioncli cache_settings --application-id 16736354321 list --details
        $ azioncli cache_settings --application-id 16736354321 list --order_by "id"
        $ azioncli cache_settings --application-id 16736354321 list --page 1  
        $ azioncli cache_settings --application-id 16736354321 list --page_size 5
        $ azioncli cache_settings --application-id 16736354321 list --sort "asc" 
        `),
