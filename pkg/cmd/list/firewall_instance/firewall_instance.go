...
func NewCobraCmd(list *ListCmd, f *cmdutil.Factory) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		SilenceErrors: true,
		Example: heredoc.Doc(`
			$ azion list firewall-instance
			$ azion list firewall-instance --firewall-id 16736354321 --details
			$ azion list firewall-instance --firewall-id 16736354321 --order-by "name"
			$ azion list firewall-instance --firewall-id 16736354321 --order-by "-name"
			$ azion list firewall-instance --firewall-id 16736354321 --page 1
			$ azion list firewall-instance --firewall-id 16736354321 --page-size 5
		`),
