...
func TestNewObjects(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			request:  httpmock.REST(http.MethodPost, "v4/edge_storage/buckets/nomedobucket/objects/nomedoobject"),
		...
		},
		{
			...
			request: httpmock.REST(http.MethodPost, "v4/edge_storage/buckets"),
