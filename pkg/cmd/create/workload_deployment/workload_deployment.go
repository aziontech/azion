...
type Fields struct {
	...
	FirewallID    int64  `json:"firewall"`
...
func NewCmd(f *cmdutil.Factory) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if cmd.Flags().Changed("file") {
				...
				if fields.ApplicationID != 0 {
					attributes.Application = fields.ApplicationID
				}

				if fields.FirewallID != 0 {
					var nullableEdgeFirewall sdk.NullableInt64
					nullableEdgeFirewall.Set(&fields.FirewallID)
	...
	flags.Int64Var(&fields.FirewallID, "firewall-id", 0, "Firewall ID for the deployment strategy")
	...
	flags.Int64Var(&fields.ApplicationID, "application-id", 0, "Application ID for the deployment strategy")
