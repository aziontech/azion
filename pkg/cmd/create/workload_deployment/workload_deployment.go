...
func NewCmd(f *cmdutil.Factory) *cobra.Command {
	...
	flags.StringVar(&fields.EdgeApplication, "application", "", "Edge Application ID for the deployment strategy")
	flags.StringVar(&fields.EdgeFirewall, "firewall", "", "Edge Firewall ID for the deployment strategy")
