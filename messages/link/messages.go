...
var (
	...
	EdgeApplicationsLinkShortDescription  = "Links a local project to an Azion edge application"
	...
	EdgeApplicationsLinkNameNotSentSimple = "The project name was not sent through the --name flag; By default, when --name is not given, the working directory is used\n"
	EdgeApplicationsLinkNameNotSentStatic = "The project name was not sent through the --name flag; By default, when --name is not given, the working directory is used\n"
