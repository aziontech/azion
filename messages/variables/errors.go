...
var (
	...
	ErrorMandatoryCreateFlags            = errors.New("One or more required flags are missing. You must provide --key, --name, and --secret flags when the --in flag is not provided. Run the command 'azioncli edge_applications create --help' to display more information and try again")
