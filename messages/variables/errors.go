...
var (
	...
	ErrorMissingFieldUpdateVariables     = errors.New("Required lags are missing. You must provide the --key, --value, and --secret flags as arguments, or the --file flag informing the path to import the file. Run the command 'azion variables <subcommand> --help' to display more information and try again")
