...
var (
	...
	ErrorMandatoryCreateFlags            = errors.New("Required flags are missing. You must provide the --key, --value, and --secret flags as arguments, or the --in flag informing the path to import the file. Run the command 'azioncli variables <subcommand> --help' to display more information and try again")
