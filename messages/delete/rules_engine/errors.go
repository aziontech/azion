...
var (
	ErrorConvertIdRule        = errors.New("The rule engine ID you provided is invalid. The value must be an integer. You may run the 'azion list rules-engine' command to check your rule engine ID")
