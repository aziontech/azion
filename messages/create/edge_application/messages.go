...
var (
	...
	FlagOriginType                     = "Type of the origin. Possible values: single-origin or load-balancer."
	FlagAddress                        = "Specify the address of a resource or server."
	FlagHostHeader                     = "Flag to customize your host headers"
	FlagOriginProtocolPolicy           = "Type of connection between the edge nodes and your origin. Possible values:"
	FlagBrowserCacheSettings           = "Configures the amount of time that content is cached in the user’s browser. Possible values:  "
