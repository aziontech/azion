...
var (
  ...
  ErrorMissingArgumentsDelete       = errors.New("A required flag is missing. You must supply an application_id and origin_key as an argument. Run 'azioncli origins list --help' command to display more information and try again")
