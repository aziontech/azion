...
var (
	ErrorMandatoryCreateFlags    = errors.New("One or more required flags are missing. You must provide --name and --application-id flags when the --in flag is not provided. Run the command 'azioncli domains create --help' to display more information and try again.")
