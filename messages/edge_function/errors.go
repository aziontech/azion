...
var (
	...
	ErrorMissingFunctionIdArgument       = errors.New("A required flag is missing. You must provide a function_id as an argument or path to import the file. Run the command again using the --help flag to display more information and try again")
	ErrorMissingFunctionIdArgumentDelete = errors.New("A required flag is missing. You must provide a function_id as an argument. Run the command again using the --help flag to display more information and try again")
	...
	ErrorGetFunction                     = errors.New("Failed to get the function: %s. Check your settings and try again. If the error persists, contact Azion support")
	ErrorGetFunctions                    = errors.New("Failed to list the functions: %s. Check your settings and try again. If the error persists, contact Azion support")
