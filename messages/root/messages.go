...
var (
	...
	APIVersionLookupFailed = "Warning: could not verify which Azion API version this account uses, so the CLI is continuing with the legacy version. Some commands may be unavailable. Check your connection and credentials, then run 'azion profiles --refresh'.\n"
