...
var (
	...
	BrewUpdate        = "Please run: 'brew upgrade azion' to update to the latest version (%s)\n"
	...
	RpmUpdate         = "Please run: 'sudo rpm -i <downloaded_file>' to update to the latest version (%s)\n"
	DpkgUpdate        = "Please run: 'sudo dpkg -i <downloaded_file>' to update to the latest version (%s)\n"
	PkgUpdate         = "Please run: 'sudo pkg install <downloaded_file>' to update to the latest version (%s)\n"
