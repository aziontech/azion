...
var (
	...
	ErrorInvalidNameFlag               = errors.New("Invalid Edge Service name. You must provide a valid Edge Service name with the flag --name. Run the command 'azioncli edge_services <subcommand> --help' to display more information and try again")
	ErrorInvalidTriggerFlag            = errors.New("The trigger flag is invalid. You must provide a valid flag --trigger value. Run the command 'azioncli edge_services resources update --help' to display more information and try again")
	ErrorInvalidContentTypeFlag        = errors.New("The resource content type is invalid. You must provide a valid flag --content-type with value <shellscript|text>. Run the command 'azioncli edge_services resources <subcommand> --help' to display more information and try again")
