...
var (
	ErrorMandatoryCreateFlags            = errors.New("One or more required flags are missing. You must provide --active, --code, and --name flags when the --in flag is not provided. Run the command 'azioncli edge_functions create --help' to display more information and try again")
	...
	ErrorMissingFunctionIdArgument       = errors.New("A required flag is missing. You must provide a function_id as an argument or path to import the file. Run the command 'azioncli edge_functions <subcommand> --help' to display more information and try again")
	ErrorMissingFunctionIdArgumentDelete = errors.New("A required flag is missing. You must provide a function_id as an argument. Run the command 'azioncli edge_functions <subcommand> --help' to display more information and try again")
