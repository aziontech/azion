...
var (
	...
	ErrorMissingFunctionIdArgument       = errors.New("A mandatory flag is missing. You must provide a function_id as an argument or path to import the file. Run the command 'azioncli edge_functions <subcommand> --help' to display more information and try again")
	ErrorMissingFunctionIdArgumentDelete = errors.New("A mandatory flag is missing. You must provide a function_id as an argument. Run the command 'azioncli edge_functions <subcommand> --help' to display more information and try again")
