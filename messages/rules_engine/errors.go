...
var (
	...
	ErrorMandatoryListFlags     = errors.New("One or more required flags are missing. You must provide the --application-id and --phase flags. Run the command 'azioncli rules_engine list --help' to display more information and try again.")
	...
	ErrorMissingArgumentsDelete = errors.New("Required flags are missing. You must supply the --application-id, --phase, and --rule-id flags as arguments. Run 'azioncli <command> <subcommand> --help' command to display more information and try again.")
	...
	ErrorMandatoryFlagsUpdate = errors.New("One or more required flags are missing. You must provide the --application-id, --rule-id, --phase, and --in flags. Run the command 'azioncli rules_engine <subcommand> --help' to display more information and try again.")
