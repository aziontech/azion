...
var (
	...
	ErrorMandatoryFlagsUpdate = errors.New("One or more required flags are missing. You must provide the --application-id, --rule-id, --phase, and --in flags. Run the command 'azion rules_engine <subcommand> --help' to display more information and try again.")
