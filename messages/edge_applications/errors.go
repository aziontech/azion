...
var (
	...
	ErrOpeningConfigFile         = errors.New("Failed to open the config.json file. The file doesn't exist, is corrupted, or has an invalid JSON format. Verify if the file was deleted or changed or run the 'azion edge_applications init' command again")
	...
	ErrFailedToRunBuildCommand   = errors.New("Failed to run the build step command. Verify if the command is correct and check the output above for more details. Try the 'azion edge_applications build' command again or contact Azion's support")
	ErrFailedToRunInitCommand    = errors.New("Failed to run the init step command. Verify if the command is correct and check the output above for more details. Try the 'azion edge_applications build' command again or contact Azion's support")
	ErrFailedToRunPublishCommand = errors.New("Failed to run the publish step command. Verify if the command is correct and check the output above for more details. Try the 'azion edge_applications build' command again or contact Azion's support")
	...
	ErrorYesAndNoOptions         = errors.New("You can use only one option at a time. Choose either --yes or --no options. Run the command 'azion edge_applications <subcommand> --help' to display more information and try again")
	...
	ErrorMissingApplicationIdArgument = errors.New("A required flag is missing. You must provide an application_id as an argument or path to import the file. Run the command 'azion edge_applications <subcommand> --help' to display more information and try again")
	...
	ErrorMandatoryCreateFlags        = errors.New("One or more required flags are missing. You must provide --active, --code, and --name flags when the --in flag is not provided. Run the command 'azion edge_applications create --help' to display more information and try again")
	ErrorActiveFlag                  = errors.New("Invalid --active flag provided. The flag must have  'true' or 'false' values. Run the command 'azion edge_applications <subcommand> --help' to display more information and try again")
	ErrorApplicationAccelerationFlag = errors.New("Invalid --application-acceleration flag provided. The flag must have  'true' or 'false' values. Run the command 'azion edge_applications <subcommand> --help' to display more information and try again")
	ErrorCachingFlag                 = errors.New("Invalid --caching flag provided. The flag must have  'true' or 'false' values. Run the command 'azion edge_applications <subcommand> --help' to display more information and try again")
	ErrorDeviceDetectionFlag         = errors.New("Invalid --device-detection flag provided. The flag must have  'true' or 'false' values. Run the command 'azion edge_applications <subcommand> --help' to display more information and try again")
	ErrorEdgeFirewallFlag            = errors.New("Invalid --edge-firewall flag provided. The flag must have  'true' or 'false' values. Run the command 'azion edge_applications <subcommand> --help' to display more information and try again")
	ErrorEdgeFunctionsFlag           = errors.New("Invalid --edge-functions flag provided. The flag must have  'true' or 'false' values. Run the command 'azion edge_applications <subcommand> --help' to display more information and try again")
	ErrorImageOptimizationFlag       = errors.New("Invalid --image-optimization flag provided. The flag must have  'true' or 'false' values. Run the command 'azion edge_applications <subcommand> --help' to display more information and try again")
	ErrorL2CachingFlag               = errors.New("Invalid --l2-caching flag provided. The flag must have  'true' or 'false' values. Run the command 'azion edge_applications <subcommand> --help' to display more information and try again")
	ErrorLoadBalancerFlag            = errors.New("Invalid --load-balancer flag provided. The flag must have  'true' or 'false' values. Run the command 'azion edge_applications <subcommand> --help' to display more information and try again")
	ErrorRawLogsFlag                 = errors.New("Invalid --raw-logs flag provided. The flag must have  'true' or 'false' values. Run the command 'azion edge_applications <subcommand> --help' to display more information and try again")
	ErrorWebApplicationFirewallFlag  = errors.New("Invalid --webapp-firewall flag provided. The flag must have  'true' or 'false' values. Run the command 'azion edge_applications <subcommand> --help' to display more information and try again")
	...
	ErrorNoFieldInformed    = errors.New("Inform at least one field to be updated. It is not possible to update an edge application without specifying the fields that will be updated. Run ‘azion edge_applications update --help’ to display more information and try again.  If the error persists, contact Azion support.")
