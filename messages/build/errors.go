...
var (
	...
	ErrFailedToRunBuildCommand = errors.New("Failed to run the build step command. Verify if the command is correct and check the output above for more details. Try the 'azion build' command again or contact Azion's support")
