...
var (
	ErrorMissingApplicationIDArgument = errors.New("A mandatory flag is missing. You must provide a application-id as an argument or path to import the file. Run the command 'azioncli device_groups <subcommand> --help' to display more information and try again")
	...
	ErrorMandatoryFlags               = errors.New("One or more required flags are missing. You must provide the --application-id and --group-id flags. Run the command 'azioncli device_groups <subcommand> --help' to display more information and try again.")
	...
	ErrorMandatoryCreateFlags         = errors.New("Required flags are missing. You must provide the application-id, name, and user-agent flags when the --application-id and --in flags are not provided. Run the command 'azioncli device_groups <subcommand> --help' to display more information and try again.")
