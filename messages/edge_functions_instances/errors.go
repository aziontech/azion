...
var (
	ErrorGetFunctions           = errors.New("Failed to get the Functions instances: %s. Check your settings and try again. If the error persists, contact Azion support")
	...
	ErrorFailToDeleteFuncInst   = errors.New("Failed to delete the Function instance: %s. Check your settings and try again. If the error persists, contact Azion support")
	...
	ErrorCreate                 = errors.New("Failed to create the Function instances: %s. Check your settings and try again. If the error persists, contact Azion support.")
	...
	ErrorGetEdgeFuncInstances   = errors.New("Failed to describe the Function instance: %s. Check your settings and try again. If the error persists, contact Azion support.")
	ErrorUpdateFuncInstance     = errors.New("Failed to update the Functions instance: %s. Check your settings and try again. If the error persists, contact Azion support.")
