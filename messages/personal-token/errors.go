...
var (
	ErrorMandatoryCreateFlags = errors.New("Required flags are missing. You must provide name and expiration flags when the --in flag is not provided. Run the command 'azioncli <command> <subcommand> --help' to display more information and try again.")
