...
var (
	ErrorMandatoryCreateFlags    = errors.New("The necessary inputs are missing. You must provide name and expiry as flags or in the json structure with the name and expiry field when using the --in flag example from json:\"{'name': 'One day token', 'expires_at': '9m'}\". Run the command 'azion <command> <subcommand> --help' to display more information and try again.")
