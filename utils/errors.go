...
var (
	...
	ErrorToken401                   = errors.New("You must create a token or the given token has expired. Manage your personal tokens on RTM using the menu Account > Personal Tokens")
	ErrorForbidden403               = errors.New("You do not have the permissions to access this API")
	ErrorNotFound404                = errors.New("Not found")
